...
Baro - Altitude hold
Mag - Use the compass to keep the heading constant
Headfree - Moving the stick back brings the aircraft toward you, no matter what direction it is facing.
Head Adj - I don't know this one.
GPS Home - Return to the home position using the gps (usually where you armed it).
GPS Hold - Stay in the current position.
...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /***************************    independent sensors    ********************************/
      ...
      //http://www.evoo.com.br/forum/viewtopic.php?t=149330  
      //#define FORCE_MAG_ORIENTATION(X, Y, Z)  {magADC[ROLL] =  -X; magADC[PITCH]  =  -Y; magADC[YAW]  = Z;} 
...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
   ...
   /* GPS protocol 
    ...
    #define MAG_DECLINIATION  -20.76f //Sao Paulo

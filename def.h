...
*/
/*
 * Configuracao do forum RCGroups
 */
#if defined(HK_MultiWii_328P )
  ...
  // Site Hobby king
  //#define MAG_ORIENTATION(X, Y, Z) {magADC[ROLL]  =  X; magADC[PITCH]  =  Y; magADC[YAW]  = Z;}
  //http://www.rclineforum.de/forum/board35-helicopter/multicopter/347942-multiwii-328p-flight-controlle/ 
  #define MAG_ORIENTATION(X, Y, Z) {magADC[ROLL] = -Y; magADC[PITCH] = X; magADC[YAW] = Z;}
  //http://www.evoo.com.br/forum/viewtopic.php?t=149330 <-- Nao Funcionou
  //#define MAG_ORIENTATION(X, Y, Z)  {magADC[ROLL] =  -X; magADC[PITCH]  =  -Y; magADC[YAW]  = Z;} 
  // Meus testes
  //#define  MAG_ORIENTATION(X, Y, Z) {magADC[ROLL]  =   -X; magADC[PITCH]  =  -Y; magADC[YAW]  = Z;}
  #define V_BATPIN A7
